...
import { StockAnalysis, ValuationInputs } from './types';
...
export default function App() {
  const [activeAnalysis, setActiveAnalysis] = useState<StockAnalysis | null>(null);
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Could not generate analysis for that ticker. Please try again.");
    } finally {
      setLoading(false);
      setSearchQuery('');
    }
  ...
  const handleUpdateInput = (key: keyof ValuationInputs, value: number) => {
          ...
          {loading && (
            ...
            >
              <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="font-mono text-xs uppercase tracking-widest text-slate-500 animate-pulse">Running Analysis Pipeline...</p>
            ...
            {[
              ...
              <button
                ...
                className={`w-full px-6 py-4 border-l-4 flex items-center gap-4 transition-all text-left ${
                  !activeAnalysis ? 'opacity-30 cursor-not-allowed' :
                  activeTab === tab.id 
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          {!activeAnalysis ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <h2 className="text-2xl font-light text-slate-800 mb-2">EquiValue</h2>
              <p className="text-slate-400 text-sm mb-8">Fundamental Intrinsic Valuation Engine</p>
              <div className="flex items-center gap-2 text-slate-300">
                <Search className="w-4 h-4" />
                <span className="text-xs font-mono">Enter a ticker symbol above to begin analysis</span>
              </div>
            </div>
          ) : (
            <>
                ...
                <div className="flex gap-4">
                   <div className="text-right">
                       <div className="flex items-center gap-2 justify-end">
                         ...
                         <span className="text-[8px] font-bold px-1 py-0.5 bg-emerald-600 text-white uppercase tracking-widest">Live</span>
                       </div>
                       ...
                       <div className="text-[9px] font-mono text-indigo-400 uppercase tracking-tighter">
                         Source: Finnhub Real-time Quote
                       </div>
                   </div>
              ...
              >
                  ...
                  <>
                    ...
                    <div className="col-span-4 bg-slate-900 p-8 text-white flex flex-col">
                      ...
                      <div className="flex-1 flex flex-col gap-10">
                        <div>
                          <div className="text-4xl font-light mb-1 font-mono tracking-tighter">{valuation ? formatPercent(valuation.wacc) : 'N/A'}</div>
                          <div className="text-[10px] uppercase tracking-wider text-slate-400 font-bold">WACC Baseline</div>
                        </div>
                        <div className="h-[1px] bg-slate-800"></div>
                        <div>
                          <div className="text-4xl font-light mb-1 font-mono tracking-tighter">{valuation ? formatCurrency(valuation.enterpriseValue) : 'N/A'}</div>
                ...
                {activeTab === 'financials' && (
                  <div className="col-span-12 bg-white border border-slate-200 p-8">
                    <FinancialTable annual={activeAnalysis.history} quarterly={activeAnalysis.quarterlyHistory} />
                  </div>
                )}
                  ...
                  <div className="col-span-12 grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-3 bg-slate-100 p-6 flex flex-col gap-6">
                       ...
                       <div className="space-y-4">
                          {(Object.entries(activeAnalysis.inputs) as [keyof ValuationInputs, number][]).map(([key, val]) => (
